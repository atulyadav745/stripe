  ...
  <div class="container mx-auto max-w-4xl">
      ...
      <div class="bg-white pt-4 rounded-xl space-y-6 overflow-hidden  transition-all duration-500 transform hover:-translate-y-6 hover:scale-105 shadow-xl hover:shadow-2xl cursor-pointer">
        ...
        <button class="inline-block my-6 text-gray-800 bg-berry  text-white font-bold py-2 rounded-full p-4 focus:bg-mauve" onClick={(() => {
              checkout({
                lineItems: [
                  {
                    price: "price_1NdZQ9SG4NQRpMPzAd9DnxaR",
                    quantity: 1
                  }
                ]
              })
    ...
    <div class="py-12">
      <div class="bg-white  pt-4 rounded-xl space-y-6 overflow-hidden transition-all duration-500 transform hover:-translate-y-6 -translate-y-2 scale-105 shadow-xl hover:shadow-2xl cursor-pointer">
        ...
        <button class="inline-block my-6 bg-berry  text-white font-bold py-2 rounded-full p-4 focus:bg-mauve" onClick={(() => {
              checkout({
                lineItems: [
                  {
                    price: "price_1NdZR0SG4NQRpMPzLwn2ZAYP",
                    quantity: 1
                  }
                ]
              })
      ...
      <div class="bg-white pt-4 rounded-xl space-y-6 overflow-hidden transition-all duration-500 transform hover:-translate-y-6 hover:scale-105 shadow-xl hover:shadow-2xl cursor-pointer">
        ...
        <button class="inline-block my-6 text-gray-800 bg-berry  text-white font-bold py-2 rounded-full p-4 focus:bg-mauve" onClick={(() => {
              checkout({
                lineItems: [
                  {
                    price: "price_1NdZRhSG4NQRpMPzmLa4GjXb",
                    quantity: 1
                  }
                ]
              })
